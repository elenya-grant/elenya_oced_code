...
class SolarResource(Resource):
    ...
    def __init__(self, lat, lon, year, path_resource="", filepath="", **kwargs):
        ...
        self.solar_attributes = 'clearsky_dhi,clearsky_dni,clearsky_ghi,ghi,dhi,dni,wind_speed,air_temperature,solar_zenith_angle,relative_humidity,surface_albedo,surface_pressure,wind_direction,total_precipitable_water'
