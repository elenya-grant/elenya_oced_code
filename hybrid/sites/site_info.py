...
class SiteInfo:
    ...
    def __init__(self, data,
        ...
        if not data['no_solar']:
            ...
            #UPDATED
            # solar_resource_path = resource_dir + 'solar/' #ADDED
            # self.solar_resource = SolarResource(data['lat'], data['lon'], data['year'], path_resource=solar_resource_path)
            # solar_resource_path = resource_dir + 'solar/' #ADDED
            self.solar_resource = SolarResource(data['lat'], data['lon'], data['year'], path_resource=resource_dir)
        ...
        if not data['no_wind']:
            ...
            #UPDATED
            # wind_resource_path = resource_dir + 'wind/'
            # self.wind_resource = WindResource(data['lat'], data['lon'], data['year'], wind_turbine_hub_ht=hub_height,
            #                                 path_resource=wind_resource_path)
            # wind_resource_path = resource_dir + 'wind/'
            self.wind_resource = WindResource(data['lat'], data['lon'], data['year'], wind_turbine_hub_ht=hub_height,
                                            path_resource=resource_dir)
            #print('test')
